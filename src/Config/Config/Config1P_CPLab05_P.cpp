...
wchar_t* Config::GetMapUrl() {
	return L"127.0.0.1:9002/1P_CPLab05_P.ut3?Game=TgGame.TgGame_Mission";
}

char* Config::GetMapUrlChar() {
	return "127.0.0.1:9002/1P_CPLab05_P.ut3?Game=TgGame.TgGame_Mission";
}

wchar_t* Config::GetMapName() {
	return L"1P_CPLab05_P.ut3";
}

char* Config::GetMapNameChar() {
	return "1P_CPLab05_P.ut3";
}
