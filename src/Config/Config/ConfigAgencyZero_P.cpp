...
wchar_t* Config::GetMapUrl() {
	return L"127.0.0.1:9002/AgencyZero_P.ut3?Game=TgGame.TgGame_Mission";
}

char* Config::GetMapUrlChar() {
	return "127.0.0.1:9002/AgencyZero_P.ut3?Game=TgGame.TgGame_Mission";
}

wchar_t* Config::GetMapName() {
	return L"AgencyZero_P.ut3";
}

char* Config::GetMapNameChar() {
	return "AgencyZero_P.ut3";
}
