...
wchar_t* Config::GetMapUrl() {
	return L"127.0.0.1:9002/Push_Toxicity.ut3?Game=TgGame.TgGame_Mission";
}

char* Config::GetMapUrlChar() {
	return "127.0.0.1:9002/Push_Toxicity.ut3?Game=TgGame.TgGame_Mission";
}

wchar_t* Config::GetMapName() {
	return L"Push_Toxicity.ut3";
}

char* Config::GetMapNameChar() {
	return "Push_Toxicity.ut3";
}
