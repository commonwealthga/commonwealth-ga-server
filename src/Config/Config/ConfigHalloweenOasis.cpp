...
wchar_t* Config::GetMapUrl() {
	return L"127.0.0.1:9002/Raid_Halloween_Oasis_P.ut3?Game=TgGame.TgGame_Defense";
}

char* Config::GetMapUrlChar() {
	return "127.0.0.1:9002/Raid_Halloween_Oasis_P.ut3?Game=TgGame.TgGame_Defense";
}

wchar_t* Config::GetMapName() {
	return L"Raid_Halloween_Oasis_P.ut3";
}

char* Config::GetMapNameChar() {
	return "Raid_Halloween_Oasis_P.ut3";
}
