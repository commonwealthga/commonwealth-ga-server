...
wchar_t* Config::GetMapUrl() {
	return L"127.0.0.1:9002/Adrenaline_P.ut3?Game=TgGame.TgGame_Mission";
}

char* Config::GetMapUrlChar() {
	return "127.0.0.1:9002/Adrenaline_P.ut3?Game=TgGame.TgGame_Mission";
}

wchar_t* Config::GetMapName() {
	return L"Adrenaline_P.ut3";
}

char* Config::GetMapNameChar() {
	return "Adrenaline_P.ut3";
}
