...
public:
	...
	// Maps the current difficultysrc/GameServer/TgGame/TgPawn/InitializeDefaultProps/TgPawn__InitializeDefaultProps.hpp_value_id (group 116) to the engine-side
