...
namespace GA_G {
	enum GA_G {
		...
		DIFFICULTY_VALUE_ID_NOVICE = 1467,
		DIFFICULTY_VALUE_ID_LOW_SECURITY = 1028,
		DIFFICULTY_VALUE_ID_ADEPT = 1468,
		DIFFICULTY_VALUE_ID_MEDIUM_SECURITY = 1029,
		DIFFICULTY_VALUE_ID_ADVANCED = 1469,
		DIFFICULTY_VALUE_ID_HIGH_SECURITY = 1030,
		DIFFICULTY_VALUE_ID_EXPERT = 1470,
		DIFFICULTY_VALUE_ID_MAXIMUM_SECURITY = 1259,
		DIFFICULTY_VALUE_ID_ULTRA_MAX_SECURITY = 1471,
		DIFFICULTY_VALUE_ID_DOUBLE_AGENT = 1260,

		DIFFICULTY_VALUE_ID_CUSTOM_MEGA_MAX_SECURITY = 3000,
		DIFFICULTY_VALUE_ID_CUSTOM_GIGA_MAX_SECURITY = 4000,
		DIFFICULTY_VALUE_ID_CUSTOM_HARDCORE_SECURITY = 5000,
		DIFFICULTY_VALUE_ID_CUSTOM_SUPER_AGENT = 10000,
	};
};
