...
// Info
#define GAME_NAME				"Global Agenda"
#define GAME_NAME_S				"GA"
#define GAME_VERSION			"1.5.1.3"
...
public:
	...
	// unsigned long			bDisableStateChanges : 1;				// 0x0038 (0x04)
...
public:
	...
	{
	public:
		class UField*		SuperField;									// 0x0040 (0x04)
		class UField*		Next;										// 0x0044 (0x04)
	...
	public:
		...
		public:
			...
			{
			public:
				unsigned char			UnknownData00[ 0x54 ];						// 0x0094 (0x54)
			...
			public:
				...
				{
				public:
					unsigned char			UnknownData00[ 0x11C ];					// 0x00E8 (0x110)
