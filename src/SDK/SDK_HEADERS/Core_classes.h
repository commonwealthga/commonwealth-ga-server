...
private:
	inline static UClass* pClassPointer = nullptr;
...
{
public:
	unsigned long                                      ClassFlags;                                    		// 0x00E4 (0x0004) [0x0000000000001002]              ( CPF_Const | CPF_Native | CPF_EditConst )
	unsigned char                                      UnknownData00[ 0x118 ];                           		// 0x00E8 (0x0118) MISSED OFFSET
