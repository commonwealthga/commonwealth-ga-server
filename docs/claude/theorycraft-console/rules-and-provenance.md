...
| **In these categories the priority IS the strength** | Data | A Poison group's application value equals its per-tick damage (15→15, 55→55, 158→158); a Regeneration group's equals its per-tick heal (66, 96, 115, 134, 154). So Strongest Wins means the harder-hitting effect survives. Contrast category 986 protection shred, where every group shares a flat 10 and the lifetime decides instead. |
