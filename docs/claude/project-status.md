...
1. **Research** — how damage, protection and effects actually resolve. `docs/claude/damage-pipeline.md`.
2. **A tool** — a theory-crafting console built on that research. `docs/claude/device-console.html`,
...
| path | what |
|---|---|
| `docs/claude/damage-pipeline.md` | The research. §0–§20. The authority for every rule the console implements. |
| `docs/claude/device-console.html` | The generated console (~3 MB, self-contained). Do not hand-edit. |
| `docs/claude/assets/device-icons/` | 115 device images, keyed by `device_id`. |
...
| `docs/claude/issues/` | Write-ups raised with the wider project. |
